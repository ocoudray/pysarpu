...
The sources for pysarpu can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/ocoudray/pysarpu
.. _tarball: https://github.com/ocoudray/pysarpu/tarball/master
